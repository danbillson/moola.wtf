...
export const addTransaction = (userId, transaction, token) => async (
  dispatch
) => {
  try {
...
export const deleteTransaction = (userId, transactionId, token) => async (
  dispatch
) => {
  try {
